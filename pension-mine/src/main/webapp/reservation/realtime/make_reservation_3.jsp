	...
	<div class="container">
		...
		<table class="table" align="center">
			<tr>
				...
				<td bgcolor="white" width="80%" align="left">ㄴㅁㄹ</td>
			</tr>
			<tr>
				<td bgcolor="#F7F6F6" width="20%" align="center">결제금액</td>
				<td bgcolor="white" width="80%" align="left">270,000 원</td>
			</tr>
			<tr>
				<td bgcolor="#F7F6F6" width="20%" align="center">결제자명</td>
				<td bgcolor="white" width="80%" align="left"><input
					...
					type="text" name="pay_user" value="ㄴㅁㄹ" maxlength="20" size="20">
				</td>
			</tr>
			<tr>
				...
				<td bgcolor="white" width="80%" align="left"><input
					style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid; BORDER-BOTTOM: #cccccc 1px solid; BACKGROUND-COLOR: white"
					type="text" name="pay_tel" maxlength="15" size="15"
					value="11-1111-1111"></td>
			</tr>
			<tr>
				<td bgcolor="#F7F6F6" width="20%" align="center">입금계좌</td>
				<td bgcolor="white" width="80%" align="left"><INPUT
					TYPE="hidden" NAME="pay_bank"
					value="우체국 : 700609-02-109658 (예금주: 최순자) "> 우체국 :
					700609-02-109658 (예금주: 최순자)</td>
			</tr>
			<tr>
				<td bgcolor="#F7F6F6" width="20%" align="center" valign="top">입금시간안내</td>
				<td bgcolor="white" width="80%" align="left"><input
					type="hidden" name="pay_year" value="2016"> <input
					type="hidden" name="pay_month" value="2"> <input
					type="hidden" name="pay_day" value="11"> <input
					type="hidden" name="pay_date2" value="오전"> <input
					type="hidden" name="pay_si" value="11"> <input
					type="hidden" name="pay_bun" value="19"> <font
					color="#990000"><b>※ 2016년 2월 11일 11시 19분 까지 (예약후 8시간
							이내)</b></font><br> ※ 지정된 시간까지 입금되지 않으면 자동으로 예약취소됩니다.<br> <!-- ※ 입금시간후 입금하셨을 경우에는 확인절차를 거쳐 환불처리 됩니다.<br> 2012.08.23 애매한표현으로 문구제거. 유희 - 정성택-->
					※ 1일전예약 또는 당일예약일 경우는 예약후 바로 입금하셔야 예약완료가 됩니다.</td>
			</tr>
		</table>
				...
				<td>
					<p align="center">
						<input type="button" width="133" height="51" border="0"
							value="다음단계" onclick="location='make_reservation_4.jsp'"><input
