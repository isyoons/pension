	...
	<div class="container-fluid text-center">
		<div class="row content">
			...
			<div class="col-sm-2 sidenav">
				<h3>About Us</h3>
				<p>
					<a href="introduce.jsp" role="button">Introduce</a>
				</p>
				<p>
					<a href="contactus.jsp" class="btn btn-primary btn-lg active">Contact Us</a>
				</p>
			</div>
			...
			<div class="col-sm-10 text-left sidecontents">
				...
				<div class="well">
					<address>
						...
						<abbr title="Phone">P:</abbr> 010-3516-3334<br> 
						<abbr title="Email">E:</abbr> temp@temp.pe.kr
					</address>
				</div>
			</div>
		</div>
