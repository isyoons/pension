...
<script src="../../script/galleryApp.js"></script>
...
<body>
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<form role="form" id="galleryForm" name="galleryForm" method="post" action="addForApp.temp" enctype="multipart/form-data">
	...
	$( document ).delegate("#img", "click", function () {
        ...
        if ( isKitkat ) {
        	window.Android.open("img", "oneImg");      
        }
	});
	</script>
</body>
